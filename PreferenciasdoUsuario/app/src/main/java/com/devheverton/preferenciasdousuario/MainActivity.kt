package com.devheverton.preferenciasdousuario
...
import com.devheverton.preferenciasdousuario.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun salvar(cor: String){
        ...
        binding.btTrocarCorDeFundo.setOnClickListener {view ->
