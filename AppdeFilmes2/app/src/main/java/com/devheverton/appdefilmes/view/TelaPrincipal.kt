...
import com.devheverton.appdefilmes.adapter.AdapterCategoria
import com.devheverton.appdefilmes.api.Api
import com.devheverton.appdefilmes.databinding.ActivityTelaPrincipalBinding
...
class TelaPrincipal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     val retrofit = Retrofit.Builder().addConverterFactory(GsonConverterFactory.create()).baseUrl("https://stackmobile.com.br/").build().create(
         Api::class.java)

        retrofit.listaCategorias().enqueue(/* callback = */ object : Callback<Categorias>{
